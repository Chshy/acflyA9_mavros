...
/*位置传感器*/
	...
	const uint8_t default_vision_sensor_index = 1;			//视觉
	const uint8_t default_ultrasonic_sensor_index = 2;		//超声波
	const uint8_t external_baro_sensor_index = 3;			//外部气压
	const uint8_t internal_baro_sensor_index = 4;			//内部气压
